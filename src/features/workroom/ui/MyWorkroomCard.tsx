...
export default async function MyWorkroomCard({ workroom }: MyWorkroomCardProps) {
  return (
    <li className='relative transition-all duration-200 hover:scale-102'>
      ...
      <div className='border-mainRed/40 flex h-87 w-144 flex-col items-center justify-center gap-4 rounded-[5px] border bg-white px-[45px] py-[30px] shadow-[0_0_13.5px_0_rgba(255,68,39,0.2)]'>
