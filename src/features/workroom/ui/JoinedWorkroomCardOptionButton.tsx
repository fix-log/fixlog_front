    ...
    <div className='relative'>
      ...
      {isDropdownOpen && (
        <button
          ...
          className='border-gray5 text-mainRed hover:bg-gray6 absolute top-8 -right-1.5 min-w-31 rounded-[5px] border bg-white px-8 py-5 transition-all duration-200 hover:cursor-pointer'
        >
          삭제하기
        </button>
      )}
